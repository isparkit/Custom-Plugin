  ...
  $searchorderid = 11086;
	...
	foreach ($customer_details as $cust){
		...
		foreach ($camper_details as $campr){
			...
			{ 
				$myparentdata = ucfirst($campr->fname) . ' ' . ucfirst($campr->lname ). ', ' . $campr->billingphone;
			}
			else
			{
				// $myparentdata = 'Data not found!';
				$myparentdata = ucfirst($campr->fname) . ' ' . ucfirst($campr->lname);
			}
			...
			<td>'.$mycamperpdf.'</td>
			<td>'.$myparentdata.',<br>'. $campr->user_email.'</td>
			<td>'.$mye1data . ' ' . $mye11data .'</td>
			<td>'.$mye2data . ' ' . $mye22data .'</td>
			<td>'.$myt1data.'</td>
			<td>'.$myt2data.'</td>
			<td>'.$myallergydata.'</td>
			<td>'.$mydeivicedata.'</td>
   ...
   $pdflogo = 'https://marinesciencecamp.com/wp-content/uploads/2022/01/MSC-Logo-Product.jpg';
	...
	<th colspan="9"> <b>Camper Count ('.$total.')</b></th>
	</tr>
	<tr style="font-weight:bold;">
	<th align="center">Camper</th>
	<th align="center">Phone</th>
	<th align="center">EC1</th>
	<th align="center">EC2</th>
	<th align="center">TA1</th>
	<th align="center">TA2</th>
	<th align="center">H</th>
	<th align="center">MD</th>
	<th align="center">ADDL</th>
	</tr>
	';  
	...
	ob_end_clean();
	$obj_pdf->Output('camper-detail-'.$product_title.'.pdf', 'D');  
	exit;
?>