...
function fetch_signup_data()
{
  ...
  foreach ($customer_details as $cust){
    ...
    // step 3
        ...
        $qryjoin 
        WHERE oim.meta_key in( 'Camper 1', 'Camper 2', 'Camper 3', 'Camper 4', 'Camper 5', 'Camper 6', 'Camper 7', 'Camper 8', 'Camper 9', 'Camper 10' ) AND oim.order_item_id in($oitemids) $qry
...
// exit;
        ...
        foreach ($camper_details as $campr){
          $osignupdata = ucfirst($campr->bookingcamper);
          $outputval .= '<tr>
          <td width="180" >'.ucfirst($campr->bookingcamper).' </td>
          <td width="44"> '.ucfirst($campr->photo).' </td>
          <td></td>
          <td></td>
          <td></td>
          <td></td>
...
// $obj_pdf->SetFont('helvetica', '', 11);
      ...
      <td width="230" ><img src="'.$pdflogo.'" width="200" /></td>
      <td width="530">
      <p><strong>'.$product_title.'</strong></p>
      <p>Lead Scientists: _________________________________________________________________</p>
      <p style="font-size:10px;">If absent, denote with "x". If photo permissions different than registration, guardian must initial box after designating the field. Guardians must initial Sign In/Out each day for chain of custody.</p>
      </td>
      </tr>
      </table>
      <br /><br />
      ...
      <th colspan="4">Camper Count  ('. $total .')</th>
      <th colspan="2" align="center">Monday</th>
      <th colspan="2" align="center">Tuesday</th>
      <th colspan="2" align="center">Wednesday</th>
      <th colspan="2" align="center">Thursday</th>
      <th colspan="2" align="center">Friday</th>
      </tr>
      <tr style="background-color:#C1E5FC;" >
      <th width="180"> Campers</th>
      ...
      ob_end_clean();
      $obj_pdf->Output('Signin-'.$product_title.'.pdf', 'D');
      // $obj_pdf->Output('Signin-'.$product_title.'.pdf');
      exit;
    ?>